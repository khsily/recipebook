...
train_path =  'C:\\Users\\Administrator\\PycharmProjects\\test4\\annotation.txt'
...
# record_df = pd.read_csv('model/record.csv')
...
for epoch_num in range(num_epochs):
    ...
    while True:
        try:
            ...
            # Convert rpn layer to roi bboxes
            R = rpn_to_roi(P_rpn[0], P_rpn[1], C, tf.keras.backend.image_data_format(), use_regr=True, overlap_thresh=0.7,
                           max_boxes=300)
