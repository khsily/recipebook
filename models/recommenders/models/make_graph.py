...
loss_8, acc_8, hit_ratio_8, ndcg_8 = graph_output('8factor_graph_neumf.csv')
...
plt.plot(epochs, loss_8, 'g', label='128factor')
plt.xlabel('epochs')
plt.ylabel('loss')
plt.legend()
plt.subplot(2, 2, 2)
...
plt.plot(epochs, acc_8, 'g', label='128factor')
plt.xlabel('epochs')
plt.ylabel('acc')
plt.legend()
plt.subplot(2, 2, 3)
...
plt.plot(epochs, hit_ratio_8, 'g', label='128factor')
plt.xlabel('epochs')
...
plt.plot(epochs, ndcg_8, 'g', label='128factor')
plt.xlabel('epochs')
plt.ylabel('ndcg')
plt.legend()
